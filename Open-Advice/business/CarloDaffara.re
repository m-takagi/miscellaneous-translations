...
@<href>{https://github.com/Open-Advice/Open-Advice/blob/master/business/CarloDaffara.tex, The original text} (licenced under CC-BY-SA)
...
#@# \end{itemize}
フリーソフトウェアベースのビジネスモデルについて、EU FLOSSMETRICSという研究がある。
200社以上の企業を分析して、オープンソース企業が使う主要なビジネスモデルを分類したものだ。
市場における主なモデルには、以下のようなものがある。

 * デュアルライセンス：ひとつのソフトウェアを、GPLとプロプライエタリなライセンスの二種類のライセンスのもとで配布する。
 このモデルは、開発者向けのツールやソフトウェアを作っている人が使うことが多い。
 また、GPL の条項に強く縛られた成果物を利用しており、その派生物や、それを直接リンクしたソフトウェアを同じライセンスで公開する必要があるという場合にも使われる。
 自分たちのソフトウェアをGPLでリリースしたくない企業は、プロプライエタリなライセンスを取得すれば、GPLの再配布条項を免除される。
 それを望む人たちもいることだろう。
 このモデルの弱点は、外部の貢献者もその制度を受け入れる必要があるという点だ。それを嫌って、外部からの貢献が減るかもしれない。
 ちょっとした機能追加やバグ修正などに、その影響が出るだろう。
 * オープンコア（かつて``プロプライエタリな付加価値''あるいは``フリーソフトウェアとプロプライエタリの分離''などと呼ばれていたもの）：
 このモデルは、基本となるフリーソフトウェア版とプロプライエタリ版を区別して、フリーソフトウェア版の上にプロプライエタリなプラグインを追加する。
 このモデルを使う企業の大半はMozilla Public Licenseを採用している。この形式のライセンスを許しており、
 外部からの貢献を受け入れる際にも、デュアルライセンスのような厳しい制約を要求せずに済むからである。
 このモデルには、本質的な弱点がある。フリーソフトウェア版そのものに価値がなければいけない（すなわち、単なる``お試し版''であってはいけない）
 その一方で、プロプライエタリ版を食ってしまうほどになってしまってもいけないという点だ。
 このバランスをうまく保って、それを維持していくのは難しい。
 ...
 * 集約サポートプロバイダー：
 複数のフリーソフトウェアプロダクトに関する、ワンストップのサポートを提供する企業。
 通常は、開発者を直接抱えるか、あるいは第二ステージのプロダクトスペシャリストに対してサポート依頼を転送する。
 * 法的な保証とコンサルティング：
 この手の企業は、何かのコードを提供するわけではなく、ライセンスへの準拠のサポートを提供する。
 また、法的な攻撃に対する補償や保険を提供することもある。
 コードが他社に不正利用されていないか、不適切な方法で使われていないかを検証するツールを提供する企業もある。
 * トレーニングおよびドキュメンテーション：
 オンラインや対面でのトレーニング、そして追加のドキュメントやマニュアルなどを提供する企業である。
 これは一般に、保守契約の一部として提供されるものだ。しかし最近では、大規模なトレーニングセンターが、
 フリーソフトウェア関連のコースを提供しはじめてもいる。
 * 研究開発コストの共有：
 企業や組織に、ソフトウェアパッケージの新バージョンが必要になることもあるだろう。そして、コンサルタントやソフトウェアメーカーに出資して、その作業を依頼する。
 後に、完成したソフトウェアをオープンソースで再配布して、そのデバッグや改良を行える開発者を増やすことでメリットを得る。
 そのよい例が、Maemoプラットフォームだ。これはNokiaがN810などのモバイルインターネット機器で使っていたものである。
 Maemoの内部のコードのうち、プロプライエタリなものはほんの7.5%に過ぎず、それによって、2億2800万ドルのコスト削減に成功した（また、開発工数も1年短縮できた）。
 Eclipseのエコシステムも、その一例だ。これは統合開発環境（IDE）で、元はIBMがフリーソフトウェアとして公開したものだったが、
 後にEclipse Foundationが管理するようになった。
 多くの企業がEclipseを基盤とした自社プロダクトを開発し、Eclipseが提供する開発者向けの機能のおかげで、ソフトウェアプロダクトの開発コストを削減した。
 多くの企業や大学そして個人たちが、Eclipseのエコシステムに関わっている。
 最近の計測によると、EclipseへのIBMの貢献は46%であり、個人開発者が25%、そしてOracleやBorlandやActuateなどの多くの企業が、1%から7%ほどの貢献をしている。
 これはLinuxカーネルの分析結果と似ており、健全かつ大規模なエコシステムで作業を共有すれば、開発コストが大幅に削減できることを示している。
 [Gosh 06]における見積もりでは、フリーソフトウェアを採用することで、ソフトウェアの研究開発のコストを36%ほど削減可能であろうとのことである。
 これ自体が、フリーソフトウェアの真の「市場」として最大なものである。開発者の多く（[ED 05]によると56.2%）が、何らかの形でフリーソフトウェアを自身のコードで使っているからだ。
 もう一つ「コーペティション」の好例としてあげられれるのがWebKitプロジェクトだ。これはHTMLレンダリングエンジンで、
